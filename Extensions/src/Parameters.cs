...
/// <summary>
/// The <c>Parameters</c> class provides additional operations on the <see cref="ParameterInfo"/> type.
/// </summary>
public static class Parameters
{
    /// <summary>
    /// Determines whether this <see cref="ParameterInfo"/> has the specified <see cref="Attribute"/>,
    /// <typeparamref name="TAttribute"/>.
    /// </summary>
    /// <typeparam name="TAttribute">The <see cref="Type"/> of attribute that this <see cref="ParameterInfo"/> is being
