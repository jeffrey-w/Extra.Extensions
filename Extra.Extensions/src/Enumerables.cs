...
public static class Enumerables
{
    ...
    /// <param name="first">One of the <see cref="IEnumerable{T}"/>s to compare.</param>
    ...
    extension<TElement>(IEnumerable<TElement> elements)
    {
        ...
        public IEnumerable<TElement> AppendIf(
            TElement element,
        ...
        /// </param>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> PrependIf(
            TElement element,
            Func<TElement, bool> predicate)
        {
        ...
        /// incremented.</param>
        /// <returns>A new <see cref="IEnumerable{T}"/>.</returns>
        public IEnumerable<(int index, TElement element)> IndexFrom(int origin)
        {
        ...
        public int SequenceHashCode(IEqualityComparer<TElement>? comparer = null)
        {
            return elements.Aggregate(
                new HashCode(),
        ...
        /// </summary>
        /// <returns>
        /// A new <see cref="IEnumerable{T}" /> that holds the same elements as
        /// this one.
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ...
        /// </summary>
        /// <returns>
        /// A new <see cref="IEnumerable{T}" /> that holds the same element as
        /// this one.
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ...
        /// </exception>
        public IDictionary<TKey, TElement> ToDictionaryInverse<TKey>(
