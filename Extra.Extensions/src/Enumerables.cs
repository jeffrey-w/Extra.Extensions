...
{
    /// <summary>
    /// Additional operation on the specified <paramref name="elements"/>.
    /// </summary>
    ...
    extension<TElement>(IEnumerable<TElement> elements)
    {
        /// <summary>
        /// Indicates whether this <see cref="IEnumerable{T}" /> contains only one element.
        /// </summary>
        /// <returns>
        ...
        public async Task<TResult> AggregateAsync<TAccumulate, TResult>(
            TAccumulate seed,
        ...
        public IEnumerable<TElement> AppendIf(TElement element, Func<TElement, bool> predicate)
        {
        ...
        /// </param>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> AppendIfNotNull(TElement? element)
        {
        ...
        /// </param>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> PrependIf(TElement element, Func<TElement, bool> predicate)
        {
        ...
        /// </param>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> PrependIfNotNull(TElement? element)
        {
        ...
        /// </remarks>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> Cached()
        {
        ...
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> ConcatSelection(Func<TElement, IEnumerable<TElement>> selector)
        {
        ...
        /// </returns>
        public bool NotAll(Func<TElement, bool> predicate)
        {
        ...
        /// </returns>
        public bool NotAny(Func<TElement, bool> predicate)
        {
        ...
        /// </param>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public async Task<IEnumerable<TResult>> SelectAsync<TResult>(Func<TElement, Task<TResult>> selector)
        {
        ...
        /// </param>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TResult> SelectNotNull<TResult>(Func<TElement, TResult?> selector)
        {
            return elements
                  .Select(selector)
                  .WhereNotNull()
        ...
        /// </summary>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> Shuffle()
        {
        ...
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> Shuffle(Random random)
        {
            return elements
        ...
        /// </returns>
        public IEnumerable<TElement> TakeWhileAggregate<TAccumulate>(
            TAccumulate seed,
        ...
        /// </exception>
        public IEnumerable<TElement> ThrowIfDuplicates()
        {
        ...
        /// <typeparamref name="TKey" />.
        /// </exception>
        public IEnumerable<TElement> ThrowIfDuplicatesBy<TKey>(Func<TElement, TKey> selector)
        {
        ...
        /// </exception>
        public IDictionary<TKey, TElement> ToDictionaryInverse<TKey>(Func<TElement, IEnumerable<TKey>> selector)
            where TKey : notnull
        {
            return elements
        ...
        /// <typeparamref name="TValue" />.
        /// </exception>
        public IDictionary<TKey, TValue> ToDictionaryInverse<TKey, TValue>(
        ...
        public ILookup<TKey, TElement> ToLookupInverse<TKey>(Func<TElement, IEnumerable<TKey>> selector)
        {
            return elements
                  .SelectMany(element => MakePairs(element, selector(element)))
        ...
        /// </param>
        /// <returns>A new <see cref="ILookup{TKey,TValue}" />.</returns>
        public ILookup<TKey, TValue> ToLookupInverse<TKey, TValue>(
            Func<TElement, IEnumerable<TKey>> keySelector,
        ...
        private static IEnumerable<(TKey key, TElement element)> MakePairs<TKey>(
            TElement element,
        ...
        /// </param>
        /// <returns>A new <see cref="IEnumerable{T}" />.</returns>
        public IEnumerable<TElement> WhereNot(Func<TElement, bool> predicate)
        {
